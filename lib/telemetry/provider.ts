...
export function initEvalTracerProvider(config: EvalTelemetryConfig): void {
  ...
  //   1. OpenSearch direct when observability data source is configured (fastest, no pipeline delay)
  //   2. OTLP/HTTP when exporterEndpoint is explicitly configured (e.g., OSIS pipeline)
