...
The AI Assistant provides conversational help powered by Claude Code CLI (with Bedrock/OpenAI-compatible fallback). Two UI interfaces share one backend.
