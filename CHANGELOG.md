...
- Assistant backend service with in-memory session management, 30-min TTL, NDJSON stream parsing, and Bedrock/OpenAI-compatible fallback ([#XXX](https://github.com/opensearch-project/agent-health/pull/XXX))
