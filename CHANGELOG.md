...
### Security
- Bump `fast-xml-parser` from 5.3.6 to 5.5.8 to fix CVE-2026-33349 (entity expansion limits bypass) ([#117](https://github.com/opensearch-project/agent-health/issues/117))
