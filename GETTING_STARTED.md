...
This guide walks you through evaluating your first AI agent in **under 10 minutes**. You'll explore demo data, run an evaluation, and learn how to connect your own agent.
...
**✓ Verify:** You should see the Agent Health dashboard with demo experiments and test cases.
