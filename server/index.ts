      ...
      server.on('listening', () => {
        ...
        try {
          ...
          if (storage) {
            ...
            // Sister recovery for the unified, top-level EvaluationRun model —
            // see server/services/evaluationRunRecoveryOnBoot.ts for why this
            // is a separate pass from the one above.
